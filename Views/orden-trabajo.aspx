<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="orden-trabajo.aspx.cs" Inherits="SPI.Mandarina_Bike.Views.ordenTrabajo" %>
                            ...
                            <div class="tab-pane fade show active" id="nav-encabezado" role="tabpanel"
                                ...
                                <div class="cont-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="establecimiento" readonly>
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="margin-bottom">
                                            ...
                                            <input type="text" class="form-control" id="conductor" readonly>
                                        </div>                               
                                    </div>
                                         <!-- /.form-group -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="kilometraje" readonly>
                                    </div>
                                     <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="serialChasis">Serial o chasis:</label>
                                        <input type="text" class="form-control" id="serialChasis" readonly>
                                    </div>
                                     <!-- /.form-group -->
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tipoOrden" readonly>
                                    </div>
                                      <!-- /.form-group -->
                                    <div class="form-group">
                                        <label for="estado">Estado:</label>
                                        <input type="email" class="form-control" id="estado" readonly>
                                    </div>
                                    <!-- /.form-group -->
                                    <div class="form-group">
                                        <div class="margin-bottom">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="fechaCompromiso" readonly>
                                    </div>                                                                                                  
                                  
                                    <!-- /.form-group -->
                                    <div class="form-group cont-amplio">
                                        <label for="observacion">Observaciones del cliente:</label>
                                        <textarea name="" id="" rows="5" readonly></textarea>
                                    </div>
                                    <div class="form-group cont-amplio">
                                        <label for="totalOrden">Total Orden:</label>
                                        <textarea name="" id="" rows="1" readonly>$ 0</textarea>
                                    </div>
                                     <!-- /.form-group -->
                                 </div>
                                <div class="flex-right">
                                    <a href="#" class="btn btn-info">Imprimir</a>
                                    <a href="#" class="btn btn-secondary">Envar</a>
                                    <a href="cliente.aspx" class="btn btn-primary">Volver</a>                                   
                                </div>
                            </div>
